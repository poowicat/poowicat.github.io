...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
      ...
      { text: '首页', link: '/' },
      {
        ...
        items: [
          // 说明：以下所有link的值只是在相应md文件头部定义的永久链接（不是什么特殊编码）。另外，注意结尾是有斜杠的
          {
            text: '深度学习文章',
            items: [
              { text: 'AI', link: '/pages/8143cc480faf9a11/' },
            ],
          },
          {
            text: '学习笔记',
    ...
    repo: 'poowicat/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    ...
    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://cdn.jsdelivr.net/gh/poowicat/image_store/blog/20200103123203.jpg',
      name: 'poowicat',
      slogan: '深度学习界的小学生',
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'poowicat | <a href="https://github.com/poowicat/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
